...
> 旧部署将自动归档；请注意保留前三行 EXECID 、 EXECNAME 、 BOTID 参数，及新参数 KingId。

> 诸如行内键盘调用类更新将不作细致更新记录，最新更新时间已首页或本页或版本号为主。

> 本仓自2022年9月10日起 已持续更新 ***73*** 次

> ***最新更新时间 2023.03.17 17:20 ***



+ **20230317**

  * > 更新maobot，内部测试版本号@Beta4.3-269。
