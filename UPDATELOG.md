...
> 本仓自2022年9月10日起 已持续更新 ***175*** 次

> ***最新更新时间 2025.06.17 16:50***


+ **20250617**

  * > 更新MaoBotV1.73「更新模块 『 MaoBot.gs 』、『 Utils.gs 』、『 Core.gs 』、『 Api.gs 』、『 Manage.gs 』」
...
+ **20250613**
  ...
  * > 更新MaoBotV1.69「更新模块 『 MaoBot.gs 』、『 Core.gs 』」

  * > 优化敏感词删除算法，针对机器人消息增加延迟删除。

+ **20250612**

  * > 更新MaoBotV1.67「更新模块 『 MaoBot.gs 』、『 Utils.gs 』、『 Core.gs 』、『 Params.gs 』、『 Manage.gs 』、『 XiaoMaoBot_DB.xlsx（新增db_telegram工作表表头） 』」

  * > 新增群聊类型用户解禁「/releaseid+用户ID」。

  * > 优化敏感词算法，三小时内三次连续触发激活用户封禁。

  * > 优化ban算法，群聊类型主动激活后移除用户24小时内发言。
...
+ **20250609**
  ...
  * > 更新MaoBotV1.55「更新模块 『 MaoBot.gs 』、『 Utils.gs 』」

  * > 加强敏感词拦截逻辑，新增对引用消息内敏感词的拦截处理。
...
+ **20250508**
  ...
  * > 更新MaoBotV1.33「更新模块 『 Manage.gs 』」

  * > 新增群管理自动获取，群管功能将自动授权于群管理。

+ **20250408**

  * > 更新MaoBotV1.32「更新模块 『 maoBot.gs 』」
...
+ **20250312**
  ...
  * > 更新MaoBotV1.30「更新模块 『 TgBot/Apps Script/MaoBot@OfficialVersion/Modules 』」
