...
**5、Dynamic configuration of sensitive words[ Dynamic new additions have been completed and dynamic deletions are under development ]「20250605 - V1.54+」**

- 敏感词的动态配置[动态新增已完成，动态删除正在进行中]
